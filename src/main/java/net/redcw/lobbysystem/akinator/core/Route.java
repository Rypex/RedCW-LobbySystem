package net.redcw.lobbysystem.akinator.core;
...
import net.redcw.lobbysystem.akinator.core.exceptions.ServerUnavailableException;
import net.redcw.lobbysystem.akinator.core.exceptions.StatusException;
import net.redcw.lobbysystem.akinator.core.impl.AkiwrapperImpl.Token;
import net.redcw.lobbysystem.akinator.core.utils.HTTPUtils;
