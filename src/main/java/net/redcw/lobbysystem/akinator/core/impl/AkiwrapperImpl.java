package net.redcw.lobbysystem.akinator.core.impl;
...
import net.redcw.lobbysystem.akinator.Akiwrapper;
import net.redcw.lobbysystem.akinator.AkiwrapperBuilder;
import net.redcw.lobbysystem.akinator.core.Route;
import net.redcw.lobbysystem.akinator.core.entities.AkiwrapperMetadata;
import net.redcw.lobbysystem.akinator.core.entities.Guess;
import net.redcw.lobbysystem.akinator.core.entities.Question;
import net.redcw.lobbysystem.akinator.core.entities.Server;
import net.redcw.lobbysystem.akinator.core.entities.Status.Level;
import net.redcw.lobbysystem.akinator.core.entities.impl.immutable.GuessImpl;
import net.redcw.lobbysystem.akinator.core.entities.impl.immutable.QuestionImpl;
import net.redcw.lobbysystem.akinator.core.entities.impl.immutable.StatusImpl;
import net.redcw.lobbysystem.akinator.core.exceptions.MissingQuestionException;
import net.redcw.lobbysystem.akinator.core.exceptions.ServerGroupUnavailableException;
import net.redcw.lobbysystem.akinator.core.exceptions.StatusException;
